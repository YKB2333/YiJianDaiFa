    ...
    switch (view.type) {
      case 'text': {
        ...
        for (let i = 0; i < textArray.length; ++i) {
          ...
          if(view.price == "salePrice"){
            console.log("this.salePrice",this.salePrice)
            this.salePrice.width = textLength
            this.salePrice.left = view.css.left
          }
          if(view.price == "plateformPrice"){
            view.css.left = this.salePrice.width + 8 + Number(this.salePrice.left.slice(0,-2)) + "px"
            console.log("view.css.left",view.css.left)
          }
